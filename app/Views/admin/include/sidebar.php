                        ...
                        <!-- <li class="nav-item">
                            ...
                            <div class="menu-dropdown collapse" id="sidebarDashboards" style="">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="<?= base_url() ?>/admin/users" class="nav-link" data-key="t-analytics">View</a>
                                    </li>
                                </ul>
                            </div>
                        </li> -->
                       <li class="nav-item">
                            <a class="nav-link menu-link" href="#colors" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="colors">
                                <i class="ri-stack-line"></i> <span data-key="t-dashboards">Colors Management</span>
                            </a>
                            <div class="menu-dropdown collapse" id="colors" style="">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="<?= base_url() ?>/admin/colors" class="nav-link" data-key="t-analytics">View</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
<!--  -->
                        <li class="nav-item">
                            ...
                            <div class="menu-dropdown collapse" id="category" style="">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="<?= base_url() ?>/admin/category" class="nav-link" data-key="t-analytics">View</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                         ...
                         <li class="nav-item">
                            <a class="nav-link menu-link" href="#styles" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="styles">
                                <i class="bx bx-category"></i> <span data-key="t-dashboards">Styles Management</span>
                            </a>
                            <div class="menu-dropdown collapse" id="styles" style="">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="<?= base_url() ?>/admin/styles" class="nav-link" data-key="t-analytics">View</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#products" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="products">
                                <i class="bx bx-category"></i> <span data-key="t-dashboards">Products Management</span>
                            </a>
                            <div class="menu-dropdown collapse" id="products" style="">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="<?= base_url() ?>/admin/products" class="nav-link" data-key="t-analytics">View</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
<!--  -->
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#content" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="content">
                               <i class="bx bx-book-content"></i> <span data-key="t-dashboards">Content Management</span>
                            </a>
                            <div class="menu-dropdown collapse" id="content" style="">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="<?= base_url() ?>/admin/content" class="nav-link" data-key="t-analytics">View</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
