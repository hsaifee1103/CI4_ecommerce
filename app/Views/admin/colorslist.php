...
<div class="page-content">
                ...
                <div class="modal-content">
                  ...
                  <!-- Modal Header -->
                   <div class="modal-header bg-light p-3">
                    <h4 class="modal-title p-0">Edit Colors</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="close-modal"></button>
                  </div>
                  
                  <!-- Modal body -->
                  <form id="edit_colors" method="post" action="#" onsubmit="return edit_colors(this , <?= $value['id']; ?>)" >
                      ...
                      <div>
                        ...
                        <div class="mt-3 text-center">
                          ...
                          <div class="remove">
                              <button class="btn btn-danger" id="delete_btns" onclick="delete_colors(<?= $value['id'] ?>)">Delete</button>
                          </div>
    ...
    <div class="modal" id="myModal">                 
                                        <div class="modal-dialog modal-dialog-centered">
                                          <div class="modal-content">
                                            ...
                                            <!-- Modal body -->
                                            <form id="add_colors" method="post" action="#" onsubmit="return add_colors()" >
                                                 <div class="modal-body">
                                                <div class="col-md-12 py-3">
                                                    <div>
                                                        <label>Title</label>
                                                        <input type="text" class="form-control"  name="title"  placeholder="Colors">
                                                    </div>
                                                   <div>
  ...
  $('.alert-danger').remove();
      ...
      $.ajax({
      url: '<?= base_url() ?>/Admin/Colors/addColors',
      type: 'POST',
      cache:false,
      contentType: false,
      processData: false,
      data:new FormData($('#add_colors')[0]),
      dataType: 'json',
      beforeSend: function() {        
...
function edit_colors(el , id) {
    $('.alert-danger').remove();
      $.ajax({
      url: '<?= base_url() ?>/Admin/Colors/editColors',
      type: 'POST',
      cache:false,
      contentType: false,
      processData: false,
...
function delete_colors(id) {
    ...
    {
        $.ajax({
      url: '<?= base_url() ?>/Admin/Colors/deleteColors',
      type: 'POST',
      cache:false,
      data:{'id':id},
      dataType: 'json',
