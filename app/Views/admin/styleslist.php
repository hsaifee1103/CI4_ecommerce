...
<div class="page-content">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Styles list</h4>
                        </div><!-- end card header -->
                        <div class="card-body">
                            <div id="customerList">
                                    ...
                                    <table class="table align-middle table-nowrap" id="example23">
                                        ...
                                        <?php if ($data): $i = 1; ?>
                                            <?php foreach ($data as $key => $value): ?>
                                                ...
                                                <td><img width="80px" src="<?= base_url($value['banner']) ?>"></td>
                ...
                <div class="modal-content">
                  ...
                  <!-- Modal Header -->
                   <div class="modal-header bg-light p-3">
                    <h4 class="modal-title p-0">Edit Styles</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="close-modal"></button>
                  </div>
                  
                  <!-- Modal body -->
                  <form id="edit_styles" method="post" action="#" onsubmit="return edit_styles(this , <?= $value['id']; ?>)" >
                      ...
                      <div>
                          ...
                          <label>Banner</label>
                          <div><img width="80px" src="<?= base_url($value['banner']) ?>"></div>
                          <input type="file" accept="image/*"  class="form-control" value=""  name="banner"  >
                        ...
                        <div class="mt-3 text-center">
                          ...
                          <div class="remove">
                              <button class="btn btn-danger" id="delete_btns" onclick="delete_styles(<?= $value['id'] ?>)">Delete</button>
                          </div>
    ...
    <div class="modal" id="myModal">                 
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                ...
                <!-- Modal body -->
                <form id="add_styles" method="post" action="#" onsubmit="return add_styles()" >
                                                 <div class="modal-body">
                                                <div class="col-md-12 py-3">
                                                    <div>
                                                        <label>Title</label>
                                                        <input type="text" class="form-control"  name="title"  placeholder="Styles">
                                                    </div>
                                                   <div>
                                                    ...
                                                    <div>
                                                      ...
                                                      <input type="file" accept="image/*" required class="form-control" value=""  name="banner"  >
  ...
  $('.alert-danger').remove();
      ...
      $.ajax({
      url: '<?= base_url() ?>/Admin/Styles/addstyles',
      type: 'POST',
      cache:false,
      contentType: false,
      processData: false,
      data:new FormData($('#add_styles')[0]),
      dataType: 'json',
      beforeSend: function() {        
...
function edit_styles(el , id) {
    $('.alert-danger').remove();
      $.ajax({
      url: '<?= base_url() ?>/Admin/Styles/editstyles',
      type: 'POST',
      cache:false,
      contentType: false,
      processData: false,
...
function delete_styles(id) {
        // event.preventDefault();
    if(confirm('Are you sure ?'))
    {
        $.ajax({
      url: '<?= base_url() ?>/Admin/Styles/deletestyles',
      type: 'POST',
      cache:false,
      data:{'id':id},
      dataType: 'json',
