                                    ...
                                    <table class="table align-middle table-nowrap" id="example23">
                                        ...
                                        <?php if ($data): $i = 1; ?>
                                            <?php foreach ($data as $key => $value): ?>
                                                ...
                                                <td><?= $value['email'] ?></td>
                                                <td><?= $value['street_address'].' '.$value['city'].' , '.$value['state'] ?></td>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        <!-- <div class="edit">
                                                            <a href="<?php echo base_url()?>/admin/edit-user/<?=$value['id']?>" class="btn btn-sm btn-info edit-item-btn" >Edit</a>
                                                        </div> -->
                                                        <?php if ($value['status'] == 1): ?>
                                                        <div class="remove">
                                                        ...
                                                        <?php endif ?>
                                                        <div class="remove">
                                                            <a href="<?php echo base_url()?>/admin/view-user/<?=$value['id']?>" class="btn btn-sm btn-primary remove-item-btn" >View</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
