                ...
                <div class="modal-content">
                  ...
                  <!-- Modal Header -->
                   <div class="modal-header bg-light p-3">
                    <h4 class="modal-title p-0">Edit Category</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="close-modal"></button>
                  </div>
                  
                  <!-- Modal body -->
                  <form id="edit_category" method="post" action="#" onsubmit="return edit_category(this , <?= $value['id']; ?>)" >
                      ...
                      <div>
                        ...
                        <div class="mt-3 text-center">
                          ...
                          <div class="remove">
                              <button class="btn btn-danger" id="delete_btns" onclick="delete_category(<?= $value['id'] ?>)">Delete</button>
                          </div>
    ...
    <div class="modal" id="myModal">                 
                                        <div class="modal-dialog modal-dialog-centered">
                                          <div class="modal-content">
                                            ...
                                            <!-- Modal body -->
                                            <form id="add_category" method="post" action="#" onsubmit="return add_category()" >
                                                 <div class="modal-body">
                                                <div class="col-md-12 py-3">
                                                    <div>
                                                        <label>Title</label>
